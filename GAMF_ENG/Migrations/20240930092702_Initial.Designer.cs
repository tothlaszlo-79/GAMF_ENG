...
namespace GAMF_ENG.Migrations
{
    ...
    [Migration("20240930092702_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GAMF_ENG.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("GAMF_ENG.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("GAMF_ENG.Models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GAMF_ENG.Models.Enrollment", b =>
                {
                    b.HasOne("GAMF_ENG.Models.Course", "Course")
                        .WithMany("Enrollments")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GAMF_ENG.Models.Student", "Student")
                        .WithMany("Enrollments")
